    ...
    return (
        <div>
            <div className="flex flex-col py-12 md:max-w-6xl w-[80%] mx-auto gap-5">
                <div className="text-5xl mb-3 font-semibold text-[#3D3D3D]">
                    Pediatric vision care
                </div>
                <div className="flex gap-5 text-gray-600 flex-col">
                    <div>
                        As a parent, you may wonder whether your preschooler has a
                        vision problem or when you should schedule your child&apos;s
                        first eye exam.
                    </div>
                    ...
                    <div>
                        ...
                        children have vision problems.* Early identification of a
                        child&apos;s vision problem can be crucial because children
                        often are more responsive to treatment when problems are
                        diagnosed early.
                    </div>
                    ...
                    <div>
                        ...
                        Children who need eyeglasses or contact lenses should be
                        examined annually or as recommended by their optometrist or
                        ophthalmologist
                    </div>

                    <div>
                        According to the American Optometric Association (AOA),
                        infants should have their first comprehensive eye exam at 6
                    ...
                    <div>
                        Early eye exams also are important because children need the
                        following basic skills related to good eyesight for
                        learning:
                    </div>
                    ...
                    <div>
                        For these reasons, some states require a mandatory eye exam
                        for all children entering school for the first time.
                    </div>
                </div>
            </div>
            <Start />
