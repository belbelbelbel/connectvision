      ...
      <div className=" w-[92%] mx-auto flex flex-col md:flex-row md:justify-between ">
        ...
        <div className="  px-4 md:flex   gap-24">
          ...
          <div className="mb-6 md:mb-0">
            <h3 className="font-bold md:text-[20px] mb-2">Quick Links</h3>
          ...
          {/* Services */}
          <div className="mb-6 md:mb-0">
            <h3 className="font-bold md:text-[20px] mb-2">Services</h3>
            <ul className="space-y-5">
          ...
          {/* Contact */}
          <div>
            <h3 className="font-bold md:text-[20px] mb-2">Address</h3>
            <p>{contact.address}</p>
            <h3 className="font-bold mt-4 text-[20px] mb-1">Telephone</h3>
            <p>{contact.phone}</p>
            <h3 className="font-bold mt-4 text-[20px] mb-1">Email Address</h3>
            <p>{contact.email}</p>
          </div>
        </div>
