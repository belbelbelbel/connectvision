        ...
        <div>
            <div className='flex flex-col  py-12 md:max-w-6xl w-[80%]  mx-auto gap-5'>
                ...
                <div className='flex gap-5 text-gray-600 flex-col'>
                    ...
                    <div> Eye exams for children are extremely important, because 5 to 10 percent of preschoolers and 25 percent of school-aged children have vision problems.* Early identification of a child's vision problem can be crucial because children often are more responsive to treatment when problems are diagnosed early.</div>
